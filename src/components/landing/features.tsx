    ...
    <li className={cn('min-h-[14rem] list-none', area)}>
      <div className="relative h-full rounded-md border-[0.75px] border-border p-2 md:rounded-lg md:p-3">
        <GlowingEffect
          ...
          borderWidth={2}
        />
        <div className="relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-sm border-[0.75px] bg-background p-6 shadow-sm shadow-black/[0.04]">
          <div className="relative flex flex-1 flex-col justify-between gap-3">
            <div className="w-fit rounded-sm border border-border/70 bg-white p-2.5 text-neutral-400 shadow-[0_1px_2px_rgba(0,0,0,0.04)] [&_svg]:stroke-[1.35]">
              {icon}
            </div>
